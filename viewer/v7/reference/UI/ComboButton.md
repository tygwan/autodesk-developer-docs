---
title: "ComboButton"
url_path: reference/UI/ComboButton
surface: viewer-sdk
...
| idstring | The id for this comboButton. Optional. |
| --- | --- |
...
| button*[Autodesk.Viewing.UI.Button](https://aps.autodesk.com/en/docs/viewer/v7/reference/UI/Button/) |   |
| --- | --- |
...
---
원본 문서: https://aps.autodesk.com/en/docs/viewer/v7/reference/UI/ComboButton
