---
operation_id: proposal-createproposal-POST
method: POST
...
```http
POST https://developer.api.autodesk.com/forma/proposal/v1alpha/proposals
```
...
```
curl -v 'https://developer.api.autodesk.com/forma/proposal/v1alpha/proposals?authcontext=pro_123' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/forma/v1/reference/http-reference/proposal-createproposal-POST
