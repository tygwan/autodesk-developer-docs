---
operation_id: integrate-createelementv2-POST
method: POST
path: /forma/integrate/v2alpha/elements
group: "integrate"
...
# To store a representation you need to first upload it to S3 by using the upload link endpoint

```http
POST https://developer.api.autodesk.com/forma/integrate/v2alpha/elements
```
...
To store a representation you need to first upload it to S3 by
using the upload link endpoint. The blobId retrieved in that
endpoint can then be used in the representation.
...
---
원본 문서: https://aps.autodesk.com/en/docs/forma/v1/reference/http-reference/integrate-createelementv2-POST
