---
operation_id: element-getelementsbatch-POST
method: POST
path: /forma/element-service/v1alpha/elements-batch
...
```http
POST https://developer.api.autodesk.com/forma/element-service/v1alpha/elements-batch
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/forma/v1/reference/http-reference/element-getelementsbatch-POST
