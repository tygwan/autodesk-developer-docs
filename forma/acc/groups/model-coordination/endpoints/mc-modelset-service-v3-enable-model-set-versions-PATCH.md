---
operation_id: mc-modelset-service-v3-enable-model-set-versions-PATCH
method: PATCH
path: /bim360/modelset/v3/containers/{containerId}/modelsets/{modelSetId}/versions:enable
...
| `409` | Conflict | Limit exceeded for enabled model sets, please disable an existing model set. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-modelset-service-v3-enable-model-set-versions-PATCH
