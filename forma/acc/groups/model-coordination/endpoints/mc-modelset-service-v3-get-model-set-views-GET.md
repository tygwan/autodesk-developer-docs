---
operation_id: mc-modelset-service-v3-get-model-set-views-GET
method: GET
path: /bim360/modelset/v3/containers/{containerId}/modelsets/{modelSetId}/views
...
```
curl -v 'https://developer.api.autodesk.com/bim360/modelset/v3/containers/f0f4f36a-ac64-687f-b132-8efe04b22454/modelsets/00fb28a5-e8a4-2755-562a-7c2f0fc87911/views?pageLimit=134&continuationToken=10&createdBy=PD23PXGV8V3V&modifiedBy=PD23PXGV8V3V&after=2015-10-21T16%3a30%3a39.000Z&before=2015-10-21T16%3a29%3a47.000Z&isPrivate=False&sortBy=Name&sortDirection=Asc' \
     -H 'Authorization: Bearer <token>'
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-modelset-service-v3-get-model-set-views-GET
