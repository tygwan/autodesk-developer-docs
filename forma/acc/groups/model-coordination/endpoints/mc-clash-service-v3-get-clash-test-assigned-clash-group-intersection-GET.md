---
operation_id: mc-clash-service-v3-get-clash-test-assigned-clash-group-intersection-GET
method: GET
...
- `groups` — `array: object`  
  ...
  - `originalClashTestId` — `string: UUID`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-get-clash-test-assigned-clash-group-intersection-GET
