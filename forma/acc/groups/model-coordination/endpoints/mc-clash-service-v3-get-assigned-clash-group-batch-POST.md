---
operation_id: mc-clash-service-v3-get-assigned-clash-group-batch-POST
method: POST
path: /bim360/clash/v3/containers/{containerId}/tests/{testId}/clashes/assigned
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-get-assigned-clash-group-batch-POST
