---
operation_id: mc-clash-service-v3-get-model-set-version-clash-tests-GET
method: GET
path: /bim360/clash/v3/containers/{containerId}/modelsets/{modelSetId}/versions/{version}/tests
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-get-model-set-version-clash-tests-GET
