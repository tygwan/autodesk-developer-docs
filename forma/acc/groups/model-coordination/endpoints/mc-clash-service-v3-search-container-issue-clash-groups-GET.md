---
operation_id: mc-clash-service-v3-search-container-issue-clash-groups-GET
method: GET
path: /bim360/clash/v3/containers/{containerId}/modelsets/{modelSetId}/clashes/assigned
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-search-container-issue-clash-groups-GET
