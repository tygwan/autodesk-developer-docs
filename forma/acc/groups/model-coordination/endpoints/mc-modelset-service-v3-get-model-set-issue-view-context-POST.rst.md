---
operation_id: mc-modelset-service-v3-get-model-set-issue-view-context-POST.rst
method: POST
path: /bim360/modelset/v3/containers/{containerId}/issues/viewcontext
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-modelset-service-v3-get-model-set-issue-view-context-POST.rst
