---
operation_id: mc-clash-service-v3-add-closed-clash-group-batch-POST
method: POST
path: /bim360/clash/v3/containers/{containerId}/tests/{testId}/clashes:close
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-add-closed-clash-group-batch-POST
