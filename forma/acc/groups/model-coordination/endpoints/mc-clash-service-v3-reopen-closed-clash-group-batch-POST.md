---
operation_id: mc-clash-service-v3-reopen-closed-clash-group-batch-POST
method: POST
path: /bim360/clash/v3/containers/{containerId}/modelsets/{modelSetId}/clashes:reopen
...
```http
POST https://developer.api.autodesk.com/bim360/clash/v3/containers/:containerId/modelsets/:modelSetId/clashes:reopen
```
...
- `array: string: UUID` — `array: string: UUID` **(필수)**  
    The array of closed clash group IDs to re-open. Min items: 1 Max items: 20.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-reopen-closed-clash-group-batch-POST
