---
operation_id: mc-modelset-service-v3-get-model-set-view-GET
method: GET
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-modelset-service-v3-get-model-set-view-GET
