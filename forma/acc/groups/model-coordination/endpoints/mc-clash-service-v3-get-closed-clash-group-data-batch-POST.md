---
operation_id: mc-clash-service-v3-get-closed-clash-group-data-batch-POST
method: POST
path: /bim360/clash/v3/containers/{containerId}/tests/{testId}/clashes/closed
...
- `clashData` — `object`  
  ...
  - `documents` — `array: object`  
    ...
    - `urn` — `string`  
        The document URN.
    - `viewableName` — `string`  
        The viewable name of the document in the model set version.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-get-closed-clash-group-data-batch-POST
