---
operation_id: mc-clash-service-v3-get-model-set-clash-tests-GET
method: GET
path: /bim360/clash/v3/containers/{containerId}/modelsets/{modelSetId}/tests
...
# Retrieves a list of summaries for all clash tests that have been executed for a given model set
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/mc-clash-service-v3-get-model-set-clash-tests-GET
