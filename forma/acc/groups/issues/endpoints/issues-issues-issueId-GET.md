---
operation_id: issues-issues-issueId-GET
method: GET
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Returns the requested issue |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/issues-issues-issueId-GET
