---
operation_id: cost-schedule-of-values-id-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/schedule-of-values/:id
```
...
| `id` | string: UUID |  | The ID of the SOV item to update. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-schedule-of-values-id-PATCH
