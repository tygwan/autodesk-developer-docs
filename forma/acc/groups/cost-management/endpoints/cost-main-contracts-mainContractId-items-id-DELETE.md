---
operation_id: cost-main-contracts-mainContractId-items-id-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items/:id
```
...
| `id` | array: string |  | The object ID of the main contract item. You can obtain this ID from the response to the POST mainContractItems or GET mainContract endpoint. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-main-contracts-mainContractId-items-id-DELETE
