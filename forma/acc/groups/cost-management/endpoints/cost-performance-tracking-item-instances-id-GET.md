---
operation_id: cost-performance-tracking-item-instances-id-GET
method: GET
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/performance-tracking-item-instances/:id
```
...
Retrieves a performance tracking item instance by ID in the given project. For more information about performance tracking, see the Cost Management API Field Guide.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-performance-tracking-item-instances-id-GET
