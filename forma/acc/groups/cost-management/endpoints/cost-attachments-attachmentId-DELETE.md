---
operation_id: cost-attachments-attachmentId-DELETE
method: DELETE
path: /cost/v1/containers/{containerId}/attachments/{attachmentId}
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/attachments/:attachmentId
```
...
| `attachmentId` | string: UUID |  | The attachment ID. |
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/attachments/18d97ae0-9484-11e8-a7ec-7ddae203e404' \
  -X 'DELETE' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-attachments-attachmentId-DELETE
