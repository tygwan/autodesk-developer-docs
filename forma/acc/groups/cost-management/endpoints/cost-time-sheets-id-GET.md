---
operation_id: cost-time-sheets-id-GET
method: GET
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/time-sheets/:id
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-time-sheets-id-GET
