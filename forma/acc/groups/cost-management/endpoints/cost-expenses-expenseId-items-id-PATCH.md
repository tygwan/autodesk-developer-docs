---
operation_id: cost-expenses-expenseId-items-id-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/expenses/:expenseId/items/:id
```
...
- `aggregateBy` — `string,null`  
    The aggregate type of the expense item. Possible values: workCompleted, workCompletedQty, materialsOnSite, materialsBilled
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-expenses-expenseId-items-id-PATCH
