---
operation_id: cost-templates-GET
method: GET
path: /cost/v1/containers/{containerId}/templates
...
# Retrieves ID, name, and timestamp information for all budget code templates in a specific project

```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/templates
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-templates-GET
