---
operation_id: cost-main-contracts-mainContractId-items-POST
method: POST
...
```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items
```
...
- `id` — `string,null`  
    An ID for the main contract item.
- `code` — `string` **(필수)**  
...
- `parentId` — `string,null`  
    The ID of the parent item of the main contract item. This is used only when creating the main contract item.
- `budgetId` — `string,null`  
    The ID of a budget to link to the main contract item.
- `unit` — `string,null`  
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/main-contracts/f6445638-ca68-4e3c-9160-15864de6b818/items' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-main-contracts-mainContractId-items-POST
