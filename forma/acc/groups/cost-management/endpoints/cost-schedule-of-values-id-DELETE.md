---
operation_id: cost-schedule-of-values-id-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/schedule-of-values/:id
```
...
| `id` | array: string: uuid |  | The ID of the SOV items to delete, separated by commas. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-schedule-of-values-id-DELETE
