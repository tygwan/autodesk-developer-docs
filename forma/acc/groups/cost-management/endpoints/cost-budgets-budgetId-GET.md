---
operation_id: cost-budgets-budgetId-GET
method: GET
path: /cost/v1/containers/{containerId}/budgets/{budgetId}
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/budgets/:budgetId
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-budgets-budgetId-GET
