---
operation_id: cost-performance-tracking-item-instances-POST
method: POST
path: /cost/v1/containers/{containerId}/performance-tracking-item-instances
...
```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/performance-tracking-item-instances
```
...
- `inputUnitPrice` — `number,string,null` **(필수)**  
...
- `outputUnitPrice` — `number,string,null` **(필수)**  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-performance-tracking-item-instances-POST
