---
operation_id: cost-budgets-budgetId-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/budgets/:budgetId
```
...
- `originalCostUnitPrice` — `number,string,null`  
    Not relevant
- `unit` — `string`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-budgets-budgetId-PATCH
