---
operation_id: cost-cost-items-costItemId-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/cost-items/:costItemId
```
...
| `costItemId` | array: string |  | The cost item ID |
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/cost-items/:costItemId' \
  -X 'DELETE' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-cost-items-costItemId-DELETE
