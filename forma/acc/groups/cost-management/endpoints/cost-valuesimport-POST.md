---
operation_id: cost-valuesimport-POST
method: POST
path: /cost/v1/containers/{containerId}/segments/{segmentId}/values:import
...
```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values:import
```
...
- `append` — `boolean`  
    true append the imported segment values to the existing values. false purge the existing segment values and replace them with the imported values.
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/segments/87256c07-5c03-42cd-b4dc-e9d06411c0cc/values:import' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-valuesimport-POST
