---
operation_id: cost-contracts-contractId-PATCH
method: PATCH
path: /cost/v1/containers/{containerId}/contracts/{contractId}
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/contracts/:contractId
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-contracts-contractId-PATCH
