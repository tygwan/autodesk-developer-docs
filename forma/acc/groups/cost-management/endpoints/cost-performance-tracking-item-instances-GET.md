---
operation_id: cost-performance-tracking-item-instances-GET
method: GET
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/performance-tracking-item-instances
```
...
| `filter[name]` | array: string |  | The item’s name. For example, filter[name]=Labor,Material. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-performance-tracking-item-instances-GET
