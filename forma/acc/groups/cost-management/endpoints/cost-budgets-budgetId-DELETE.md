---
operation_id: cost-budgets-budgetId-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/budgets/:budgetId
```
...
| `budgetId` | array: string: uuid |  | The budget ID. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-budgets-budgetId-DELETE
