---
operation_id: cost-cost-items-costItemId-GET
method: GET
path: /cost/v1/containers/{containerId}/cost-items/{costItemId}
...
# Gets a cost item specified by ID

```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/cost-items/:costItemId
```
...
| `costItemId` | string |  | The ID of the cost item. |
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/cost-items/f6445638-ca68-4e3c-9160-15864de6b818' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-cost-items-costItemId-GET
