---
operation_id: cost-values-valueId-PATCH
method: PATCH
path: /cost/v1/containers/{containerId}/segments/{segmentId}/values/{valueId}
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values/:valueId
```
...
| `valueId` | string: UUID |  | The segment value ID. To obtain a segment value ID, use GET segments/:segmentId/values. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-values-valueId-PATCH
