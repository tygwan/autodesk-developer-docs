---
operation_id: cost-properties-GET
method: GET
path: /cost/v1/containers/{containerId}/properties
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/properties
```
...
- `name` — `string`  
    Name of a attribute definition. Max length: 1024
- `type` — `enum:string`  
...
- `collaboratorAccess` — `string,null`  
    The access level granted to collaborators for this custom attribute. Possible values: no_access, view, edit.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-properties-GET
