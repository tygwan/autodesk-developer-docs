---
operation_id: cost-main-contracts-id-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:id
```
...
| `id` | array: string |  | The object ID of the main contract. You can obtain this ID from the response to the POST mainContract or GET mainContract endpoint. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-main-contracts-id-DELETE
