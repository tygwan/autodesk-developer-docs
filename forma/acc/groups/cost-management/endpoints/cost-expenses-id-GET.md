---
operation_id: cost-expenses-id-GET
method: GET
path: /cost/v1/containers/{containerId}/expenses/{id}
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/expenses/:id
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-expenses-id-GET
