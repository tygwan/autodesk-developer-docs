---
operation_id: cost-time-sheets-id-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/time-sheets/:id
```
...
| `id` | string |  | The timesheet ID. To find the timesheet ID, call GET time-sheets and inspect results.id in the response. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-time-sheets-id-PATCH
