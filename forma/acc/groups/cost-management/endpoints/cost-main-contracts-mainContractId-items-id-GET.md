---
operation_id: cost-main-contracts-mainContractId-items-id-GET
method: GET
path: /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items/{id}
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/main-contracts/:mainContractId/items/:id
```
...
| `mainContractId` | string: UUID |  | The ID of the main contract. To find the main contract ID, call GET main-contracts and inspect results.id in the response. |
| `id` | string: UUID |  | The object ID of the item. To find the item IDs, call GET main-contracts/:mainContractId/items and inspect results.id in the response. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-main-contracts-mainContractId-items-id-GET
