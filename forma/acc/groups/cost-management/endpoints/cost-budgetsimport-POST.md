---
operation_id: cost-budgetsimport-POST
method: POST
path: /cost/v1/containers/{containerId}/budgets:import
...
# Imports a list of budgets into a project chunk by chunk

```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/budgets:import
```
...
- `append` — `boolean`  
    true if you want to append the new budgets to the project. false if you want to purge existing budgets before importing the new budgets.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-budgetsimport-POST
