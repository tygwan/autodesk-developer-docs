---
operation_id: cost-segment-values-GET
method: GET
path: /cost/v1/containers/{containerId}/segment-values
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/segment-values
```
...
- `results` — `array: object`  
  ...
  - `code` — `string`  
      The display code. Max length: 255
  - `originalCode` — `string`  
      The original value of the code before the delimiters are removed. Max length: 255
  - `description` — `string`  
      The description of the code. Max length: 2048
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-segment-values-GET
