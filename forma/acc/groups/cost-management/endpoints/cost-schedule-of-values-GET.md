---
operation_id: cost-schedule-of-values-GET
method: GET
path: /cost/v1/containers/{containerId}/schedule-of-values
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/schedule-of-values
```
...
| `filter[includeChangeOrders]` | boolean |  | false: (default) will Returns only original contracted SOV items. true: will include items from approved change orders. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-schedule-of-values-GET
