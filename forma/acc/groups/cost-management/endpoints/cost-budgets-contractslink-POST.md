---
operation_id: cost-budgets-contractslink-POST
method: POST
path: /cost/v1/containers/{containerId}/budgets-contracts:link
...
# Link or unlink one or multiple budgets with one or multiple contracts

```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/budgets-contracts:link
```
...
- `create` — `array: object`
  - `contractId` — `string: UUID`  
      ID of the Contract to which the budget to link.
  - `budgetId` — `string: UUID`  
      ID of the Budget to which the contract should be linked.
- `remove` — `array: object`
  - `contractId` — `string: UUID`  
      ID of the Contract to which the budget to link.
  - `budgetId` — `string: UUID`  
      ID of the Budget to which the contract to link.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-budgets-contractslink-POST
