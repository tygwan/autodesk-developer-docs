---
operation_id: cost-attachmentsbatch-create-POST
method: POST
path: /cost/v1/containers/{containerId}/attachments:batch-create
...
```http
POST https://developer.api.autodesk.com/cost/v1/containers/:containerId/attachments:batch-create
```
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/attachments:batch-create' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-attachmentsbatch-create-POST
