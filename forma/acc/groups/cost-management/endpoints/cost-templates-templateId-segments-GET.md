---
operation_id: cost-templates-templateId-segments-GET
method: GET
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/templates/:templateId/segments
```
...
| 이름 | 타입 | 필수 | 설명 |
| --- | --- | --- | --- |
| `filter[name]` | string |  | Returns only items with the specified name. For example, filter[name]=Labor. Max length: 255 |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-templates-templateId-segments-GET
