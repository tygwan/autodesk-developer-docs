---
operation_id: cost-values-GET
method: GET
path: /cost/v1/containers/{containerId}/segments/{segmentId}/values
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-values-GET
