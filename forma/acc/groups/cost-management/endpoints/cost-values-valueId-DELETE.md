---
operation_id: cost-values-valueId-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/segments/:segmentId/values/:valueId
```
...
| `valueId` | array: string: uuid |  | The segment value ID. To obtain a segment value ID, use GET segments/:segmentId/values. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-values-valueId-DELETE
