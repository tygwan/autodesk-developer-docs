---
operation_id: cost-payments-GET
method: GET
path: /cost/v1/containers/{containerId}/payments
...
```http
GET https://developer.api.autodesk.com/cost/v1/containers/:containerId/payments
```
...
- `results` — `array: object`  
    The project cost payments or budget payments.
  - `id` — `string: UUID`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-payments-GET
