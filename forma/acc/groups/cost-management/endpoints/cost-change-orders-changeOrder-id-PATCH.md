---
operation_id: cost-change-orders-changeOrder-id-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/cost/v1/containers/:containerId/change-orders/:changeOrder/:id
```
...
- `description` — `string`  
    The description of the change order. Max length: 2048
- `type` — `string,null`  
...
- `scopeOfWork` — `string`  
    The scope of work of the change order. This is a Tiptap formatted rich text (https://tiptap.dev/introduction/).
- `note` — `string`  
    Additional notes to the change order. This is a Tiptap formatted rich text (https://tiptap.dev/introduction/).
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | The Change Order is updated successfully. |
...
```
curl -v 'https://developer.api.autodesk.com/cost/v1/containers/e94b9bc8-1775-4d76-9b1d-c613e120ccff/change-orders/pco/18d97ae0-9484-11e8-a7ec-7ddae203e404' \
  -X 'PATCH' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-change-orders-changeOrder-id-PATCH
