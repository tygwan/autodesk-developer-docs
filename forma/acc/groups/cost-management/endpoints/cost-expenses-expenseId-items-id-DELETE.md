---
operation_id: cost-expenses-expenseId-items-id-DELETE
method: DELETE
...
```http
DELETE https://developer.api.autodesk.com/cost/v1/containers/:containerId/expenses/:expenseId/items/:id
```
...
| `id` | array: string: uuid |  | A list of the object IDs of the expense items whose items you want to retrieve, separated by commas. You can obtain these IDs from the response to the POST expenses/:expenseId/items or GET expenses/:expenseId/items endpoint. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-expenses-expenseId-items-id-DELETE
