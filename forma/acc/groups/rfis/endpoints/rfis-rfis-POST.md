---
operation_id: rfis-rfis-POST
method: POST
path: /construction/rfis/v3/projects/{projectId}/rfis
group: "RFIs"
...
```http
POST https://developer.api.autodesk.com/construction/rfis/v3/projects/:projectId/rfis
```
...
- `id` — `string: UUID`  
    Unique identifier for the RFI. This is system-generated and should not be included when creating a new RFI unless the client needs to set the RFI ID in advance.
...
- `reference` — `string`  
    An external ID. Typically used when the RFI was created in another system. Max length: 20
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/rfis-rfis-POST
