---
operation_id: rfis-rfis-id-responses-POST
method: POST
path: /construction/rfis/v3/projects/{projectId}/rfis/{rfiId}/responses
group: "RFIs"
...
```http
POST https://developer.api.autodesk.com/construction/rfis/v3/projects/:projectId/rfis/:rfiId/responses
```
...
```
curl -v 'https://developer.api.autodesk.com/construction/rfis/v3/projects/:projectId/rfis/:rfiId/responses' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/rfis-rfis-id-responses-POST
