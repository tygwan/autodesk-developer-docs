---
operation_id: takeoff-projects-project_id-packages-POST
method: POST
...
```http
POST https://developer.api.autodesk.com/construction/takeoff/v1/projects/{projectId}/packages
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/takeoff-projects-project_id-packages-POST
