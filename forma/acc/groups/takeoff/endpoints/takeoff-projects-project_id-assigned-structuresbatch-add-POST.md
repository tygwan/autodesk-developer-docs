---
operation_id: takeoff-projects-project_id-assigned-structuresbatch-add-POST
method: POST
path: /construction/takeoff/v1/projects/{projectId}/assigned-structures:batch-add
group: "Takeoff"
...
# Assigns one or more classification structures (trees) to a Takeoff project

```http
POST https://developer.api.autodesk.com/construction/takeoff/v1/projects/{projectId}/assigned-structures:batch-add
```
...
Assigns one or more classification structures (trees) to a Takeoff project. A project can have a maximum of five assigned structures.
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `201` | Created | Successfully added the project assigned structures. |
| `400` | Bad Request | The parameters of the requested operation are invalid. |
| `401` | Unauthorized | The provided bearer token is not valid. |
| `403` | Forbidden | The user or service represented by the bearer token does not have permission to perform this operation. |
| `404` | Not Found | The requested resource could not be found. |
| `409` | Conflict | One or more of the project assigned structures may already exist. |
...
- `results` — `array: object`  
    The list of classification structures that were added to the project.
...
```
curl -v 'https://developer.api.autodesk.com/construction/takeoff/v1/projects/:projectId/assigned-structures:batch-add' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/takeoff-projects-project_id-assigned-structuresbatch-add-POST
