---
operation_id: takeoff-projects-project_id-packages-package_id-takeoff-items-GET
method: GET
path: /construction/takeoff/v1/projects/{projectId}/packages/{packageId}/takeoff-items
group: "Takeoff"
...
```http
GET https://developer.api.autodesk.com/construction/takeoff/v1/projects/{projectId}/packages/{packageId}/takeoff-items
```
...
| `limit` | int |  | The maximum number of takeoff items per page. Acceptable values: 1-10000. Default value: 1000. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/takeoff-projects-project_id-packages-package_id-takeoff-items-GET
