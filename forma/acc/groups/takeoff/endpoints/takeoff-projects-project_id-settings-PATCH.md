---
operation_id: takeoff-projects-project_id-settings-PATCH
method: PATCH
path: /construction/takeoff/v1/projects/{projectId}/settings
group: "Takeoff"
...
```http
PATCH https://developer.api.autodesk.com/construction/takeoff/v1/projects/{projectId}/settings
```
...
- `measurementSystem` — `enum:string` **(필수)**  
    The project measurement system. Possible values: IMPERIAL, METRIC.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/takeoff-projects-project_id-settings-PATCH
