---
operation_id: takeoff-projects-project_id-packages-package_id-takeoff-types-GET
method: GET
path: /construction/takeoff/v1/projects/{projectId}/packages/{packageId}/takeoff-types
group: "Takeoff"
...
```http
GET https://developer.api.autodesk.com/construction/takeoff/v1/projects/{projectId}/packages/{packageId}/takeoff-types
```
...
| `limit` | int |  | The maximum number of takeoff types per page. Accepatble values: 1-10000. Default value: 1000. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/takeoff-projects-project_id-packages-package_id-takeoff-types-GET
