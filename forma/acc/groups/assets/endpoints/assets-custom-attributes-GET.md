---
operation_id: assets-custom-attributes-GET
method: GET
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successfully returned a page of custom attributes. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-custom-attributes-GET
