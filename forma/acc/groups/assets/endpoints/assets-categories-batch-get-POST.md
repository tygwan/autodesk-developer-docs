---
operation_id: assets-categories-batch-get-POST
method: POST
path: /construction/assets/v1/projects/{projectId}/categories:batch-get
group: "Assets"
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/categories:batch-get
```
...
- `ids` — `array: string`  
    Unique IDs of categories to fetch
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-categories-batch-get-POST
