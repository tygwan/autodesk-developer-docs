---
operation_id: assets-assets-batch-create-POST-v2
method: POST
path: /construction/assets/v2/projects/{projectId}/assets:batch-create
group: "Assets"
...
```http
POST https://developer.api.autodesk.com/construction/assets/v2/projects/{projectId}/assets:batch-create
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-assets-batch-create-POST-v2
