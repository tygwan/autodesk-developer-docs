---
operation_id: assets-categories-POST
method: POST
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/categories
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-categories-POST
