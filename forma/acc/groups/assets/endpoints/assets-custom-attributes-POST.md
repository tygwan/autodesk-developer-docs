---
operation_id: assets-custom-attributes-POST
method: POST
path: /construction/assets/v1/projects/{projectId}/custom-attributes
group: "Assets"
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/custom-attributes
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-custom-attributes-POST
