---
operation_id: assets-custom-attributes-custom-attribute-id-PATCH
method: PATCH
path: /construction/assets/v1/projects/{projectId}/custom-attributes/{customAttributeId}
group: "Assets"
...
```http
PATCH https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/custom-attributes/{customAttributeId}
```
...
```
curl -v 'https://developer.api.autodesk.com/construction/assets/v1/projects/:projectId/custom-attributes/3063f212-6ce9-494e-b749-eb73b4445bf0' \
  -X 'PATCH' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-custom-attributes-custom-attribute-id-PATCH
