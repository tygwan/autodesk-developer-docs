---
operation_id: assets-asset-statuses-batch-get-POST
method: POST
path: /construction/assets/v1/projects/{projectId}/asset-statuses:batch-get
group: "Assets"
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/asset-statuses:batch-get
```
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successfully returned a batch of statuses. |
...
```
curl -v 'https://developer.api.autodesk.com/construction/assets/v1/projects/:projectId/asset-statuses:batch-get?includeDeleted=true' \
  -X 'POST' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-asset-statuses-batch-get-POST
