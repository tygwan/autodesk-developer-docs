---
operation_id: assets-status-step-sets-batch-get-POST
method: POST
path: /construction/assets/v1/projects/{projectId}/status-step-sets:batch-get
group: "Assets"
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/status-step-sets:batch-get
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-status-step-sets-batch-get-POST
