---
operation_id: assets-asset-statuses-POST
method: POST
...
```http
POST https://developer.api.autodesk.com/construction/assets/v1/projects/{projectId}/asset-statuses
```
...
- `statusStepSetId` — `string: UUID` **(필수)**  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-asset-statuses-POST
