---
operation_id: assets-categories-category-id-custom-attributes-GET
method: GET
path: /construction/assets/v1/projects/{projectId}/categories/{categoryId}/custom-attributes
group: "Assets"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/assets-categories-category-id-custom-attributes-GET
