---
operation_id: reviews-getworkflow-GET
method: GET
path: /construction/reviews/v1/projects/{projectId}/workflows/{workflowId}
group: "Reviews"
...
| `workflowId` | string: UUID |  | The ID of the approval workflow. To find available workflow IDs, call GET Workflows. |
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successfully retrieved the approval workflow. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/reviews-getworkflow-GET
