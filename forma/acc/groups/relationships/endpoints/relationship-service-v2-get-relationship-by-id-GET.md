---
operation_id: relationship-service-v2-get-relationship-by-id-GET
method: GET
path: /bim360/relationship/v2/containers/{containerId}/relationships/{relationshipId}
group: "Relationships"
...
| `relationshipId` | string: UUID |  | The GUID that uniquely identifies the relationship. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/relationship-service-v2-get-relationship-by-id-GET
