---
operation_id: relationship-service-v2-search-relationships-GET
method: GET
path: /bim360/relationship/v2/containers/{containerId}/relationships:search
group: "Relationships"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/relationship-service-v2-search-relationships-GET
