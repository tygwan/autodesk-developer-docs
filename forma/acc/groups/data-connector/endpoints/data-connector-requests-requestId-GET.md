---
operation_id: data-connector-requests-requestId-GET
method: GET
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successfully returned a data request. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/data-connector-requests-requestId-GET
