---
operation_id: data-connector-requests-requestId-DELETE
method: DELETE
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/data-connector-requests-requestId-DELETE
