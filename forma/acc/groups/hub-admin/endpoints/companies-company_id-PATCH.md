---
operation_id: companies-:company_id-PATCH
method: PATCH
...
```http
PATCH https://developer.api.autodesk.com/hq/v1/accounts/:account_id/companies/:company_id
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/companies-:company_id-PATCH
