---
operation_id: companies-GET-legacy
method: GET
...
- `account_id` — `string: UUID`  
    Account/Hub ID
- `name` — `string`  
    Company name should be unique under a hub Max length: 255
- `trade` — `string`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/companies-GET-legacy
