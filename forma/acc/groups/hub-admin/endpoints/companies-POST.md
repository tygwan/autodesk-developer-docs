...
```http
POST https://developer.api.autodesk.com/hq/v1/accounts/:account_id/companies
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/companies-POST
