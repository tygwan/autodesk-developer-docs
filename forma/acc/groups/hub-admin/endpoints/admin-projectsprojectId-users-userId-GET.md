---
operation_id: admin-projectsprojectId-users-userId-GET
method: GET
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/admin-projectsprojectId-users-userId-GET
