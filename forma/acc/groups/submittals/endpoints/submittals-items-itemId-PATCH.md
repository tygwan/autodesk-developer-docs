---
operation_id: submittals-items-itemId-PATCH
method: PATCH
...
# Updates specific attributes of an existing submittal item

```http
PATCH https://developer.api.autodesk.com/construction/submittals/v2/projects/:projectId/items/:itemId
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-items-itemId-PATCH
