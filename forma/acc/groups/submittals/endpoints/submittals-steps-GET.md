---
operation_id: submittals-steps-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/items/{itemId}/steps
group: "Submittals"
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Review steps for the submittal item successfully retrieved. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-steps-GET
