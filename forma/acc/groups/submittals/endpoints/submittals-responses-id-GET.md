---
operation_id: submittals-responses-id-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/responses/{id}
group: "Submittals"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-responses-id-GET
