---
operation_id: submittals-tasks-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/items/{itemId}/steps/{stepId}/tasks
group: "Submittals"
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | List of tasks successfully retrieved. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-tasks-GET
