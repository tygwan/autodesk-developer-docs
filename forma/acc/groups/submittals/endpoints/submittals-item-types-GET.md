---
operation_id: submittals-item-types-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/item-types
group: "Submittals"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-item-types-GET
