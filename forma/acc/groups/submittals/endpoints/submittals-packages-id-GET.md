---
operation_id: submittals-packages-id-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/packages/{id}
group: "Submittals"
...
# Retrieve details about a single package
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-packages-id-GET
