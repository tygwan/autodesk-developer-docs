---
operation_id: submittals-mappings-GET
method: GET
...
# Retrieves users, roles, and companies assigned the manager role in the current project
...
| `filter[autodeskId]` | string |  | Comma-seperated list of Autodesk IDs for which the mappings will be returned. |
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successful retrieval of user-role mappings. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-mappings-GET
