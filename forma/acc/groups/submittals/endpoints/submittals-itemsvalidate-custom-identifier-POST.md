---
operation_id: submittals-itemsvalidate-custom-identifier-POST
method: POST
path: /construction/submittals/v2/projects/{projectId}/items:validate-custom-identifier
group: "Submittals"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-itemsvalidate-custom-identifier-POST
