---
operation_id: submittals-mappings-mappingId-DELETE
method: DELETE
path: /construction/submittals/v2/projects/{projectId}/settings/mappings/{mappingId}
group: "Submittals"
...
# Deletes an admin mapping from the project

```http
DELETE https://developer.api.autodesk.com/construction/submittals/v2/projects/:projectId/settings/mappings/:mappingId
```
...
Deletes an admin mapping from the project. A mapping defines a user, role, or company as a Submittal Manager, allowing them to be assigned as a manager on individual submittal items.
...
| `mappingId` | string: UUID |  | The ID of the user-role mapping. Each mapping represents a user, role, or company assigned as a Submittal Manager in the project. To retrieve the mapping ID, call GET mappings. |
...
```
curl -v 'https://developer.api.autodesk.com/construction/submittals/v2/projects/9eae7d59-1469-4389-bfb2-4114e2ba5545/settings/mappings/99fc8896-e72c-4be1-97d0-8d063c7060bf' \
  -X 'DELETE' \
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-mappings-mappingId-DELETE
