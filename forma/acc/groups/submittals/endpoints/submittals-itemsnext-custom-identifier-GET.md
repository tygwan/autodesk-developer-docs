---
operation_id: submittals-itemsnext-custom-identifier-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/items:next-custom-identifier
group: "Submittals"
...
# Retrieves the next available custom identifier for a submittal item in a project
...
- `previousCustomIdentifier` — `string`  
    The last created custom identifier.
- `nextCustomIdentifier` — `string`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-itemsnext-custom-identifier-GET
