---
operation_id: submittals-specs-GET
method: GET
...
# Retrieve all the spec sections for the specified project
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-specs-GET
