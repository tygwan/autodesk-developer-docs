---
operation_id: submittals-attachments-attachmentId-PATCH
method: PATCH
path: /construction/submittals/v2/projects/{projectId}/items/{itemId}/attachments/{attachmentId}
group: "Submittals"
...
```http
PATCH https://developer.api.autodesk.com/construction/submittals/v2/projects/:projectId/items/:itemId/attachments/:attachmentId
```
...
| `attachmentId` | string |  | The ID of the attachment. To find the ID, call GET attachments. |
...
- `isFileUploaded` — `boolean`  
    Indicates whether the attachment upload is complete. Set this field to true once the file upload is finished. true: the attachment upload is complete. false: (default) the attachment upload is still in progress or pending completion.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-attachments-attachmentId-PATCH
