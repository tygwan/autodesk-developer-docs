---
operation_id: submittals-responses-GET
method: GET
path: /construction/submittals/v2/projects/{projectId}/responses
group: "Submittals"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-responses-GET
