---
operation_id: sheets-uploads-uploadId-GET
method: GET
path: /construction/sheets/v1/projects/{projectId}/uploads/{uploadId}
group: "Sheets"
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-uploads-uploadId-GET
