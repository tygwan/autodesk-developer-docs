---
operation_id: sheets-review-sheetspublish-POST
method: POST
path: /construction/sheets/v1/projects/{projectId}/uploads/{uploadId}/review-sheets:publish
group: "Sheets"
...
```http
POST https://developer.api.autodesk.com/construction/sheets/v1/projects/{projectId}/uploads/{uploadId}/review-sheets:publish
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-review-sheetspublish-POST
