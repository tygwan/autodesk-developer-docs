---
operation_id: sheets-version-sets-versionSetId-PATCH
method: PATCH
path: /construction/sheets/v1/projects/{projectId}/version-sets/{versionSetId}
group: "Sheets"
...
| `versionSetId` | string |  | The ID of the version set. To find the version set ID, call GET version-sets. |
...
| 코드 | 의미 | 설명 |
| --- | --- | --- |
| `200` | OK | Successfully updated the version set. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-version-sets-versionSetId-PATCH
