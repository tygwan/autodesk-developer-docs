---
operation_id: sheets-version-setsbatch-get-POST
method: POST
path: /construction/sheets/v1/projects/{projectId}/version-sets:batch-get
group: "Sheets"
...
- `ids` — `array: string`  
    The IDs of the version sets to retrieve. - The max number of items is 200.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-version-setsbatch-get-POST
