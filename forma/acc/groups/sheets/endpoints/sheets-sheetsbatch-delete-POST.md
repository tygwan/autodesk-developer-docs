---
operation_id: sheets-sheetsbatch-delete-POST
method: POST
path: /construction/sheets/v1/projects/{projectId}/sheets:batch-delete
group: "Sheets"
...
```http
POST https://developer.api.autodesk.com/construction/sheets/v1/projects/{projectId}/sheets:batch-delete
```
...
- `ids` — `array: string` **(필수)**  
    The IDs of the sheets to delete. To find the sheet IDs, call GET sheets. - The max number of items is 200.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-sheetsbatch-delete-POST
