---
operation_id: sheets-version-setsbatch-delete-POST
method: POST
path: /construction/sheets/v1/projects/{projectId}/version-sets:batch-delete
group: "Sheets"
...
```http
POST https://developer.api.autodesk.com/construction/sheets/v1/projects/{projectId}/version-sets:batch-delete
```
...
- `ids` — `array: string` **(필수)**  
    The IDs of the version set to delete. To find the version set IDs, call GET version-sets. - The max number of items is 10.
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/sheets-version-setsbatch-delete-POST
