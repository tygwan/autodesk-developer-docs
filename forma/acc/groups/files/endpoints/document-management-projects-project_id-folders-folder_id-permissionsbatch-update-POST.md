---
operation_id: document-management-projects-project_id-folders-folder_id-permissionsbatch-update-POST
method: POST
path: /bim360/docs/v1/projects/{project_id}/folders/{folder_id}/permissions:batch-update
group: "Files"
...
# Updates the permissions assigned to multiple users, roles, and companies for a folder
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/document-management-projects-project_id-folders-folder_id-permissionsbatch-update-POST
