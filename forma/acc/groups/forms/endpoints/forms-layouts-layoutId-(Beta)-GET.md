---
operation_id: forms-layouts-layoutId-(Beta)-GET
method: GET
path: /construction/forms/v1/projects/{projectId}/layouts/{layoutId}
group: "Forms"
...
```http
GET https://developer.api.autodesk.com/construction/forms/v1/projects/:projectId/layouts/:layoutId
```
...
- `layout` — `object`
  ...
  - `type` — `enum:string`  
      The type of the layout. Will always be: form
  - `description` — `string`  
      The description of the layout.
  - `hasSectionAssignees` — `boolean`  
      Determines if section assignment is enabled.
- `sections` — `array: object`  
    The list of sections within the layout.
  - `uid` — `string: UUID`  
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/forms-layouts-layoutId-(Beta)-GET
