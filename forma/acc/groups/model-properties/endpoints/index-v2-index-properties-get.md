---
operation_id: index-v2-index-properties-get
method: GET
path: /construction/index/v2/projects/{projectId}/indexes/{indexId}/properties
...
# Retrieve the specific properties index
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/index-v2-index-properties-get
