---
operation_id: index-v2-diff-query-job-status-get
method: GET
path: /construction/index/v2/projects/{projectId}/diffs/{diffId}/queries/{queryId}
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/index-v2-diff-query-job-status-get
