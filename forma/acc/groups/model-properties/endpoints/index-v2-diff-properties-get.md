---
operation_id: index-v2-diff-properties-get
method: GET
path: /construction/index/v2/projects/{projectId}/diffs/{diffId}/properties
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/index-v2-diff-properties-get
