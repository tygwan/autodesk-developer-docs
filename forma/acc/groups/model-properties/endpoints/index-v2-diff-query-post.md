---
operation_id: index-v2-diff-query-post
method: POST
path: /construction/index/v2/projects/{projectId}/diffs/{diffId}/queries
...
---
원본 문서: https://aps.autodesk.com/en/docs/acc/v1/reference/http/index-v2-diff-query-post
