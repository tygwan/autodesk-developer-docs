...
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement/ServiceApiException
...
Represents an exception that is returned when an API call fails.
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement/ServiceApiException
