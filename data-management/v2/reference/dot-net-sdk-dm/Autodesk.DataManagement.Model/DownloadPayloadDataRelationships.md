---
title: "DownloadPayloadDataRelationships Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/DownloadPayloadDataRelationships
...
---
# Class DownloadPayloadDataRelationships
...
```
[DataContract]
public class DownloadPayloadDataRelationships
```
...
```
public DownloadPayloadDataRelationships()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/DownloadPayloadDataRelationships
