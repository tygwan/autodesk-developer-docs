---
title: "VersionDataRelationshipsStorage Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsStorage
...
---
# Class VersionDataRelationshipsStorage
...
```
[DataContract]
public class VersionDataRelationshipsStorage
```
...
```
public VersionDataRelationshipsStorage()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsStorage
