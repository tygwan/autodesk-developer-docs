---
title: "PublishModelAttributesExtension Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/PublishModelAttributesExtension
...
---
# Class PublishModelAttributesExtension
...
```
[DataContract]
public class PublishModelAttributesExtension
```
...
```
public PublishModelAttributesExtension()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/PublishModelAttributesExtension
