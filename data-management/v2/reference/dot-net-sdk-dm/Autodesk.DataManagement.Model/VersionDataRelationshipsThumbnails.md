---
title: "VersionDataRelationshipsThumbnails Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsThumbnails
...
---
# Class VersionDataRelationshipsThumbnails
...
```
[DataContract]
public class VersionDataRelationshipsThumbnails
```
...
```
public VersionDataRelationshipsThumbnails()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsThumbnails
