---
title: "CheckPermissionPayloadAttributesExtensionData Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/CheckPermissionPayloadAttributesExtensionData
...
---
# Class CheckPermissionPayloadAttributesExtensionData
...
```
[DataContract]
public class CheckPermissionPayloadAttributesExtensionData
```
...
```
public CheckPermissionPayloadAttributesExtensionData()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/CheckPermissionPayloadAttributesExtensionData
