---
title: "TopFolderDataRelationships Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/TopFolderDataRelationships
...
---
# Class TopFolderDataRelationships
...
```
[DataContract]
public class TopFolderDataRelationships
```
...
```
public TopFolderDataRelationships()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/TopFolderDataRelationships
