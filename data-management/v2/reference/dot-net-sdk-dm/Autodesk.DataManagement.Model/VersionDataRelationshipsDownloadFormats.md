---
title: "VersionDataRelationshipsDownloadFormats Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsDownloadFormats
...
---
# Class VersionDataRelationshipsDownloadFormats
...
```
[DataContract]
public class VersionDataRelationshipsDownloadFormats
```
...
```
public VersionDataRelationshipsDownloadFormats()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionDataRelationshipsDownloadFormats
