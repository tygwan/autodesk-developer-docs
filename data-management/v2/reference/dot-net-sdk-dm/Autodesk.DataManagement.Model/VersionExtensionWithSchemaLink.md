---
title: "VersionExtensionWithSchemaLink Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionExtensionWithSchemaLink
...
---
# Class VersionExtensionWithSchemaLink
...
```
[DataContract]
public class VersionExtensionWithSchemaLink
```
...
```
public VersionExtensionWithSchemaLink()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/VersionExtensionWithSchemaLink
