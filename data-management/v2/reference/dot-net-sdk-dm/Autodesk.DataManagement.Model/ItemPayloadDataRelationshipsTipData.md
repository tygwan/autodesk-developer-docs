---
title: "ItemPayloadDataRelationshipsTipData Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/ItemPayloadDataRelationshipsTipData
...
---
# Class ItemPayloadDataRelationshipsTipData
...
```
[DataContract]
public class ItemPayloadDataRelationshipsTipData
```
...
```
public ItemPayloadDataRelationshipsTipData()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/ItemPayloadDataRelationshipsTipData
