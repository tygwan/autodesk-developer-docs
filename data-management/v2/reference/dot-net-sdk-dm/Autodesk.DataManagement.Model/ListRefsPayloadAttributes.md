---
title: "ListRefsPayloadAttributes Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/ListRefsPayloadAttributes
...
---
# Class ListRefsPayloadAttributes
...
```
[DataContract]
public class ListRefsPayloadAttributes
```
...
```
public ListRefsPayloadAttributes()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/ListRefsPayloadAttributes
