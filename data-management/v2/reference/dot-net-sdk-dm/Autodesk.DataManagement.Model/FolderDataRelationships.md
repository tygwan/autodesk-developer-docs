---
title: "FolderDataRelationships Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/FolderDataRelationships
...
```
[DataContract]
public class FolderDataRelationships
```
...
### FolderDataRelationships()

Initializes a new instance of the class.

```
public FolderDataRelationships()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/FolderDataRelationships
