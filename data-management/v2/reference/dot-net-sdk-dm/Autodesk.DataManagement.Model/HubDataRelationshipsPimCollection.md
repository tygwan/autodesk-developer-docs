---
title: "HubDataRelationshipsPimCollection Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/HubDataRelationshipsPimCollection
...
---
# Class HubDataRelationshipsPimCollection
...
```
[DataContract]
public class HubDataRelationshipsPimCollection
```
...
```
public HubDataRelationshipsPimCollection()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/HubDataRelationshipsPimCollection
