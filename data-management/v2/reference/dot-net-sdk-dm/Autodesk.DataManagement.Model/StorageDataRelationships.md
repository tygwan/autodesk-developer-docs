---
title: "StorageDataRelationships Class"
url_path: reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/StorageDataRelationships
...
---
# Class StorageDataRelationships
...
```
[DataContract]
public class StorageDataRelationships
```
...
```
public StorageDataRelationships()
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/dot-net-sdk-dm/Autodesk.DataManagement.Model/StorageDataRelationships
