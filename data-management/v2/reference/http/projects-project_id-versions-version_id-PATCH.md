---
title: "PATCH projects/:project_id/versions/:version_id"
url_path: reference/http///projects-project_id-versions-version_id-PATCH
...
section: "reference"
category: "http"
operation_id: "projects-project_id-versions-version_id-PATCH"
method: "PATCH"
...
| Method and URI | PATCH https://developer.api.autodesk.com/data/v1/projects/:project_id/versions/:version_id |
| --- | --- |
...
| 200OK | Successful update of a specific version’s properties. |
| --- | --- |
...
Successful update of a specific version’s properties.
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-versions-version_id-PATCH
