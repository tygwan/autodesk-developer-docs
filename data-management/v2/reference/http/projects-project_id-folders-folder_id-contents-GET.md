---
title: "GET projects/:project_id/folders/:folder_id/contents"
url_path: reference/http///projects-project_id-folders-folder_id-contents-GET
...
section: "reference"
category: "http"
operation_id: "projects-project_id-folders-folder_id-contents-GET"
method: "GET"
...
| Method and URI | GET https://developer.api.autodesk.com/data/v1/projects/:project_id/folders/:folder_id/contents |
| --- | --- |
...
| filter[type]array: string | Filter by the `type` of the objects in the folder. Supported values include `folders` and `items`. |
| --- | --- |
| filter[id]array: string | Filter by the `id` of the `ref` target. |
| filter[extension.type]array: string | Filter by the extension type. |
| filter[lastModifiedTimeRollup]array: string | Filter by the `lastModifiedTimeRollup` in `attributes`
...
| includeHiddenboolean | `true`: response will also include items and folders that were deleted from BIM 360 Docs projects.
`false` (default): response will not include items and folders that were deleted from BIM 360 Docs projects.
To return only items and folders that were deleted from BIM 360 Docs projects, see the [Filtering](https://aps.autodesk.com/en/docs/data/v2/overview/filtering/) section. |

### Response

## HTTP Status Code Summary

| 200OK | Successful retrieval of the folder contents collection associated with a specific folder. |
| --- | --- |
...
| hrefstring | A hyperlink reference to this resource. |
| dataarray: object | The array of data objects. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-folders-folder_id-contents-GET
