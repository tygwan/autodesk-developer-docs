---
title: "GET projects/:project_id/versions/:version_id/downloadFormats"
url_path: reference/http///projects-project_id-versions-version_id-downloadFormats-GET
...
section: "reference"
category: "http"
operation_id: "projects-project_id-versions-version_id-downloadFormats-GET"
method: "GET"
...
| 200OK | Successful retrieval of the available download formats for a specific version. |
| --- | --- |
...
| dataobject | The object containing information on the download_formats of the resource. |
| typeenum:string | The type of this resource. Will always be: `downloadFormats` |
| idstring | The id of the resource. |
| attributesobject | The attributes of the download format. |
| formatsarray: object | An array of supported download formats for this resource. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-versions-version_id-downloadFormats-GET
