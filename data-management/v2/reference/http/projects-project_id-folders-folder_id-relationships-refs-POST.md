---
title: "POST projects/:project_id/folders/:folder_id/relationships/refs"
url_path: reference/http///projects-project_id-folders-folder_id-relationships-refs-POST
...
section: "reference"
category: "http"
operation_id: "projects-project_id-folders-folder_id-relationships-refs-POST"
method: "POST"
...
---
# projects/:project_id/folders/:folder_id/relationships/refs

Creates a custom relationship between a folder and another resource within the `data` domain service (folder, item, or version).

## Resource Information

| Method and URI | POST https://developer.api.autodesk.com/data/v1/projects/:project_id/folders/:folder_id/relationships/refs |
| --- | --- |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-folders-folder_id-relationships-refs-POST
