---
title: "GET projects/:project_id/folders/:folder_id"
url_path: reference/http///projects-project_id-folders-folder_id-GET
...
section: "reference"
category: "http"
operation_id: "projects-project_id-folders-folder_id-GET"
method: "GET"
...
| Method and URI | GET https://developer.api.autodesk.com/data/v1/projects/:project_id/folders/:folder_id |
| --- | --- |
...
| --- | --- |
| If-Modified-Sincestring | If the resource has not been modified since, the response will be a 304 without any body; the `Last-Modified` response header will contain the date of last modification. |
...
| --- | --- |
| 304Not Modified | The specified resource has not been modified since. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-folders-folder_id-GET
