---
title: "GET projects/:project_id/versions/:version_id/refs"
url_path: reference/http///projects-project_id-versions-version_id-refs-GET
...
section: "reference"
category: "http"
operation_id: "projects-project_id-versions-version_id-refs-GET"
method: "GET"
...
---
# projects/:project_id/versions/:version_id/refs
...
| Method and URI | GET https://developer.api.autodesk.com/data/v1/projects/:project_id/versions/:version_id/refs |
| --- | --- |
...
| dataarray: object | The data object. |
...
| includedobject | The object containing information on the ref of the resource. |
| typeenum:string | The type of this resource.
Possible values: `folders`, `items`, `versions` |
| idstring | The id of the resource. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-versions-version_id-refs-GET
