---
title: "GET projects/:project_id/versions/:version_id/downloads"
url_path: reference/http///projects-project_id-versions-version_id-downloads-GET
...
section: "reference"
category: "http"
operation_id: "projects-project_id-versions-version_id-downloads-GET"
method: "GET"
...
| 200OK | Successful retrieval of the available downloads collection associated with a specific version. |
| --- | --- |
...
| dataarray: object | The array of download objects. |
...
---
원본 문서: https://aps.autodesk.com/en/docs/data/v2/reference/http/projects-project_id-versions-version_id-downloads-GET
