---
title: "Get a 3-Legged Token with Authorization Code Grant (PKCE) for Private Clients"
url_path: tutorials/get-3-legged-token-pkce/get-3-legged-token-pkce-private
...
The authorization code grant type with PKCE is used to obtain both access tokens and refresh tokens and PKCE is strongly recommended for private clients as well but is not an optimization.
...
Before you begin, follow the [Create an App](https://aps.autodesk.com/en/docs/oauth/v2/tutorials/create-app) walkthrough. Refer to the section, Step 2: Register an App and select Traditional Web App to create your app on the APS developer Platform. Specify your app’s callback URL and note your client ID and secret.

Refer to the following image to familiarize yourself with the PKCE overall flow:
- **Private client PKCE flow** ![../../../_images/authorization-code-3-legged-flow_private.png](https://developer.doc.autodesk.com/bPlouYTd/cloud-platform-id-pubdocs-master-756267/_images/authorization-code-3-legged-flow_private.png)
...
---
원본 문서: https://aps.autodesk.com/en/docs/oauth/v2/tutorials/get-3-legged-token-pkce/get-3-legged-token-pkce-private
