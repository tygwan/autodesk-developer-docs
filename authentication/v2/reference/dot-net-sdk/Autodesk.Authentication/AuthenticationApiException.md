---
title: "AuthenticationApiException Class"
url_path: reference/dot-net-sdk/Autodesk.Authentication/AuthenticationApiException
...
```
public class AuthenticationApiException : ServiceApiException, ISerializable
```
...
[ServiceApiException](https://aps.autodesk.com/en/docs/oauth/v2/reference/dot-net-sdk/Autodesk.Authentication/ServiceApiException) ←
...
[ServiceApiException.HttpResponseMessage](https://aps.autodesk.com/en/docs/oauth/v2/reference/dot-net-sdk/Autodesk.Authentication/ServiceApiException),
...
### AuthenticationApiException(string)
...
### AuthenticationApiException(string, HttpResponseMessage, Exception)

```
public AuthenticationApiException(string message, HttpResponseMessage httpResponseMessage, Exception exception)
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/oauth/v2/reference/dot-net-sdk/Autodesk.Authentication/AuthenticationApiException
