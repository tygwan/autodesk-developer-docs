---
title: "JobPayloadFormatThumbnail Class"
url_path: reference/dot-net-sdk/Autodesk.ModelDerivative.Model/JobPayloadFormatThumbnail
...
---
# Class JobPayloadFormatThumbnail
...
```
[DataContract]
public class JobPayloadFormatThumbnail : IJobPayloadFormat
```

## Inheritance

[object](https://learn.microsoft.com/dotnet/api/system.object) ←
[JobPayloadFormatThumbnail](https://aps.autodesk.com/en/docs/model-derivative/v2/reference/dot-net-sdk/Autodesk.ModelDerivative.Model/JobPayloadFormatThumbnail)
...
```
public JobPayloadFormatThumbnail()
```
...
public JobPayloadFormatAdvancedThumbnail Advanced { get; set; }
```
...
---
원본 문서: https://aps.autodesk.com/en/docs/model-derivative/v2/reference/dot-net-sdk/Autodesk.ModelDerivative.Model/JobPayloadFormatThumbnail
