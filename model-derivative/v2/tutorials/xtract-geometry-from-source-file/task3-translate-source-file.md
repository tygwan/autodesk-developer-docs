...
url_path: tutorials/xtract-geometry-from-source-file/task3-translate-source-file
...
---
원본 문서: https://aps.autodesk.com/en/docs/model-derivative/v2/tutorials/xtract-geometry-from-source-file/task3-translate-source-file
