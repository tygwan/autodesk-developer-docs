...
url_path: tutorials/prep-roominfo4viewer/task4-display_model
...
- In the **Access Token** box, specify the access token you obtained in Task 1 of this walkthrough.
...
- Click **Submit**. You should see a screen similar to the following. ![../../../../_images/task7_default_viewable.png](https://developer.doc.autodesk.com/bPlouYTd/A360-platform-viewing-docs-master-766554/_images/task7_default_viewable.png)

---
원본 문서: https://aps.autodesk.com/en/docs/model-derivative/v2/tutorials/prep-roominfo4viewer/task4-display_model
